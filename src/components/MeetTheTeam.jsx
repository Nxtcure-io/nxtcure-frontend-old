              ...
              >
                <div className="flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-justify text-gray-600 text-sm">
                      Ishita Kapoor is a technologist, 2x co-founding
                      impact-driven ventures that merge tech innovation with
                      strategic business insight. A Schwarzman Scholar, startup
                      board member at IIT Roorkee, she has earned accolades from
                      Microsoft, Google, and UNICEF, with 30+ national and
                      international hackathon wins. Ishita has presented her
                      work to Microsoft CEO Satya Nadella and now closely works
                      with Microsoft as one of their PR partners. She was also
                      awarded India’s Best Research Paper of the Year in 2023,
