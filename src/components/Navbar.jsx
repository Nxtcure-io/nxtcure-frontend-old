    ...
    <header className="w-full shadow-sm sticky top-0 left-0 z-50 bg-white">
        ...
        <nav className="hidden md:flex space-x-8 items-center">
          ...
          <div className="relative" ref={dropdownRef}>
            <button 
              ...
              className="nav-txt text-gray-700 hover:text-blue-600 font-medium transition cursor-pointer flex items-center"
            >
              NxtTrials
              <ChevronDown 
      ...
      {menuOpen && (
        <div className="md:hidden bg-white px-6 py-4 space-y-4 shadow-md z-40">
          <Link to="/" className="block text-gray-700 font-medium" onClick={() => setMenuOpen(false)}>
            Home
          </Link>
          <button 
            onClick={() => scrollToSection('about')} 
