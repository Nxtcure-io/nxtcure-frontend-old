...
export default function WaitlistBanner() {
  return (
    <section className="flex flex-col items-center justify-center px-6 py-6 text-center bg-[radial-gradient(circle_at_center,_#020202_10%,_#020202_30%,_#800080_80%)]">
